...
int main()
{
    ...
    ImVec4 moveRect = ImVec4(0.0f, 0.0f, 0.0f, 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Text("Change rectangle color:");
        ...
        // *** Move Rectangle ***
        ImGui::Text("Move rectangle:");
        ImGui::SliderFloat("dx", &moveRect.x, -1.0f, 1.0f);
        ImGui::SliderFloat("dy", &moveRect.y, -1.0f, 1.0f);
        ...
        glUniform1f(dx, moveRect.x);
        glUniform1f(dy, moveRect.y);
